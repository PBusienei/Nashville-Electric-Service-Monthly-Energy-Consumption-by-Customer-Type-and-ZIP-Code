...
I created a dashboard that hosted different pieces of information. I used matplotlib.pyploy to create different visualizations, I used Power BI and Tableau to created geolocation and meter visualizations. 
